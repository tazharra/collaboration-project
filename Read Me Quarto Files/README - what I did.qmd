...
The raw data in the format Karl gave us can be found can be found in the
folder: Initial Data From Collaborator.
...
To create the plot, I first made the plots separately and the combined
them at the end.
